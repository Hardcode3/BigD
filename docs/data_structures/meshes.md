...
!!! quote
    ...
    - [https://imagecomputing.net/damien.rohmer/teaching](https://imagecomputing.net/damien.rohmer/teaching/inf585/practice/content/006/index.html)

## Loading meshes

### Python

From [Dmitry Sokolov](https://github.com/ssloy/ENSG.git){target=_blank}
